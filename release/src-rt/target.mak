...
export TUF-AX5400 += BUILD_NAME="TUF-AX5400" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=y WTFAST=n REPEATER=y IPV6SUPP=y \
		...
		NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=y NEW_APP_ARM=y VISUALIZATION=n BONDING=y \
		BONDING_WAN=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=y IFTTT=n SW_HW_AUTH=y HD_SPINDOWN=y ASPMD=n \
...
export TUF-AX5400 += TOR=y NTPD=y DNSPRIVACY=y DNSFILTER=y NTPD=y OPENSSL11=y NANO=y 
